...
<% request.setAttribute("pageTitleKey", "ui.myPage.menu.recent.title"); %>
...
<main class="recipe-container">
    ...
    <div class="upload-summary-box fixed-summary">
        <p class="summary-line"
           data-i18n="ui.myPage.recent_summary.title">
        </p>

        <p class="summary-sub"
           data-i18n="ui.myPage.recent_summary.desc">
        </p>
    </div>
            ...
            <c:when test="${empty recentRecipes}">
                <div class="empty-result empty-upload-recipe">
                    <div class="empty-icon">
                        <img src="/images/emptyRecentRecipe.png">
                    </div>
                </div>
            </c:when>
...
<script type="module" src="/js/page/mypage/recentRecipe.js"></script>
</body>
</html>
